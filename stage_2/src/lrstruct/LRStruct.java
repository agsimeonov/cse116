...
public class LRStruct<E> {
	...
	private static abstract class AState<E> {
		...
		public abstract <InputType, OutputType> OutputType execute(IAlgo<InputType, E, OutputType> algo, LRStruct<E> host, InputType arg);
	}
	...
	private static class EmptyState<E> extends AState<E> {
		...
		/* (non-Javadoc)
		 * @see lrstruct.LRStruct.AState#execute(lrstruct.LRStruct.IAlgo, lrstruct.LRStruct, InputType)
		 */
		@Override
		public <InputType, OutputType> OutputType execute(IAlgo<InputType, E, OutputType> algo, LRStruct<E> host, InputType arg) {
	...
	public interface IAlgo<InputType, ElementType, OutputType> {
		 ...
		 */
		public abstract OutputType emptyCase(LRStruct<ElementType> host, InputType arg);
		 ...
		 * @return The value returned by the visitor.
		 */
		public abstract OutputType nonEmptyCase(LRStruct<ElementType> host, InputType arg);
	}
